			...
			<!--		<div class="aa-product-catg-head">
					...
					<div class="tab-pane fade in active" id="men">
                      ...
                      <div style="width:70%; margin:auto; padding:2px; ">
                          ...
                          <div class="com_add">
                            <a class="aa-add-card-btn" href="{{ url('/product/'.$allproduct->id) }}" style="height:100%; background:{{$bg_t_c}}; color:white;text-transform: capitalize; ">{{ $allproduct->product_name }}<br>{{ $allproduct->price }} Tk  @if($allproduct->unit !="N/A")
