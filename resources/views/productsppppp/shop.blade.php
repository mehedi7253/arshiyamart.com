			...
			<!--		<div class="aa-product-catg-head">
					...
					<div class="tab-pane fade in active items" id="men">
					    ...
					    <div class="row">
					        ...
					        <span style="font-size:200%">{{$asdd->shop_name}}</span><br>
...
<?php
		        	            ...
		        	            $allproducttsk = DB::table('s_product')->where('shop_id',2)->groupBy('c_id')->get();
...
?>
		                      					        ...
		                      					        <div style=" width: auto; float:left">
		                      					            <span style="color:red"><b>Our Menu <i class="fa fa-bars" aria-hidden="true"></i></b>
</span> 
		                      					            </div>
...
{{ $allproductt->c_id}}
		...
		<?php
		        	            ...
		        	            $allproductsk = DB::table('products')->where('id',$allproductt->product_id)->where('status',1)->get();
...
?>
			...
			if(!isset($show))
			{
			    echo '<h2 style="margin-bottom:250px">Comming Soon all product in this store.</h2>';
			}
			?>			
