...
<select name="tps" required="">
    ...
    <option value=""></option>
              ...
              <div class="form-group">
              <textarea name="billing_address" id="billing_address" type="text" style="width:100%" required="" placeholder="Delivery Address ">@if(!empty($userDetails->address)) {{ $userDetails->address }} @endif</textarea>    
...
<label for="pg"><i class="fa fa-credit-card" aria-hidden="true" style="font-size:150%; color:red"></i> <i class="fa fa-mobile" aria-hidden="true" style="font-size:150%; color:blue"></i> (Card/Mobile Banking/Net Banking)</label><br>
