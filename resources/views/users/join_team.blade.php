...
<label> যে নম্বর থেকে পে করেছেন (শুধু  মাত্র বিকাশ/রকেট/নগদের জন্য)</label><br>
    	<input name="sender_number" type="number"  placeholder="Sender Number" style="width:100%" minlength="11">	
				...
				@if($affiliate_block>0)
									
									
												<?php
									
									$viyyyyyy= DB::table('users')->where('id',$affiliate_block)->first();
									$affiliate_block_mobile=$viyyyyyy->phone;
									?>				
...
<input name="up_line_id" type="hidden"  placeholder="Reference/Up Line ID" value="{{$affiliate_block_mobile}}"  minlength="11" required="" style="width:100%"> 
<input name="join_auth_code" type="hidden"  placeholder="Authorisation  Code" value="{{$affiliate_block}}"  minlength="4" required="" style="width:100%">
