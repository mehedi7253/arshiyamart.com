...
@if(!isset($_GET['e']))				
		<h3 style="text-align:center; background:pink; color:white; padding:5px; border-radius:5px">
			        ...
			        <br>
			        <span style="color:black"> {{$user}}</span><br>
			     <b>   <span style="color:black">{{$mnnnnn}}</span></b>
			        
			             
			         <a href="/profile?e=1" style="color:blue">   <i class="fa fa-pencil-square-o" aria-hidden="true" style="color:blue"></i></a>
			    </h3>
	...
	?>
            ...
            <tr>
            	    ...
            	    <?php
            	    $up_line_id_n=DB::table('users')->where('id',$up_line_id)->first();
            	    ?>
            	    {{
            	    ...
            	    @$ddddddd=date('d/m/Y', strtotime($j_date->created_at));
            	    @$my_age_ddddddd=date('d/m/Y', strtotime($j_date->created_at));
            	    ?>
...
@$birth_date     = new DateTime("$j_date->created_at");
...
//echo $seconds   = $diff->h + ($diff->days * $hours_in_day * $minutes_in_hour * $seconds_in_mins) . " seconds"; echo "<br/>";  
	...
	@endif
		...
		<table>
             ...
             <tr>
            	    <td>NID </td>
            	    <td><input type="number" name="nid" value="{{$nid}}" required=""/> </td>
            </tr>       	
            ...
            <tr>
            	    ...
            	    <td><input type="text" name="date_of_birth" value="{{$dob}}" required=""/> </td>
            </tr>    	
            ...
            <tr>
            	    <td>Father's Name </td>
            	    <td><input type="text" name="father_name" value="{{$father}}" required=""/> </td>
            </tr>       	
...
<button type="submit" class="btn btn-default" style="width:100%; background:silver">Update Profile</button>
			      ...
			      <div class="row" style="margin-bottom:100px; margin:auto;">
