...
;?> 
          ...
          <div class="widget-box">
            <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
              <h5 style="color:red"> BDT এ্যাপ্রুভ করার পর তা আর ডিলেডট করা যাবে না। তাই এ্যাপ্রুভ করার পূর্বে ভাল করে লক্ষ করতে হবে।</h5>
            </div>
                      ...
                      <td>{{ $i++ }}</td>
                       ...
                       <td class="center">
                           @if($pay->status!=2)
                                                       ...
                                                       <a href="{{ url('/admin/app_paybdt/'.$pay->id) }}"  style="padding:8px; background:green; color:white"> Approved</a>
