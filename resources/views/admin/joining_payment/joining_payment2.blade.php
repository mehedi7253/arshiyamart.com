...
@section('content')
  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{ url('/admin/add-product') }}" >Withdraw </a> <a href="{{ url('/admin/view-products') }}" class="current">Withdraw</a> </div>
      <h1>Withdraw</h1>
    </div>
          ...
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              <table class="table table-bordered data-table">
                   ...
                   @foreach ($viewpayment as $pay)
                    <tr class="gradeX">
                      <td>{{ $i++ }}</td>
                       ...
                       <td class="center">
                           @if($pay->status!=2)
                            <a href="{{ url('/admin/app_pay2/'.$pay->id) }}" style="padding:8px; background:green; color:white"> Approved</a>
                            @else
                            <a href="#">Complete</a>
                ...
                <td>
                                        	Amount:<span style="color:red; font-size:140%"> {{ $pay->amount }}.00BDT</span><br>
                                        	Method: <span style="color:blue; font-size:140%">{{ $pay->payment_method}}</span><br>
                                        	Number: <span style="color:blue; font-size:140%">{{ $pay->sender_number}}</span><br>
