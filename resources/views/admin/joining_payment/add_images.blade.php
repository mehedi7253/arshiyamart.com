  ...
  <div id="content">
    ...
    <div class="container-fluid"><hr>
      <div class="row-fluid">
        ...
        <h6 style="color:red"> একাধিক ইমেইল যুক্ত করার ক্ষেত্রে প্রতিটি ইমেজের সাইজ সর্বোচ্চ 200 কেবি এর মধ্যে রাখবেন। ( উচ্চতা: 600px  ও প্রস্ত 300px  এর মধ্যে থাকলে সাইট দ্রুত লোড হবে।) </h5>
