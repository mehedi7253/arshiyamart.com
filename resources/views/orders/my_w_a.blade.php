...
<h2 style="color:black; padding:20px 50px; text-align:center"> Withdraw <br>       <span style="color:red">  Available balance= {{$total_cash_wallet+$total_cash_wallet_w}} </span><br>
 </h2>
...
@else
        ...
        @if($total_cash_wallet+$total_cash_wallet_w<1000000)
        			<form id="account_Form" class="aa-login-form" name="accountForm" action="#" method="post">
        								@csrf
        ...
        @else
        <h5 style="color:black; padding:20px 50px; text-align:center">      <span style="color:green">  আপনার ব্যালেন্স 270/- টাকার  কম হলে আপনি Withdraw করতে পারবেন না।। </span><br>
         </h5>
