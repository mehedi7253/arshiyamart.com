...
@else
        ...
        @if($total_cash_wallet+$total_cash_wallet_w>9)
        ...
        <select name="payment_method" style="width:100%; padding:6px;" required>
                ...
                <option value="Rockate">Rocket</option>
        ...
        @else
        <h5 style="color:black; padding:20px 50px; text-align:center">      <span style="color:green">  আপনার ব্যালেন্স  10/- টাকার  কম হলে আপনি Withdraw করতে পারবেন না।। </span><br>
         </h5>
