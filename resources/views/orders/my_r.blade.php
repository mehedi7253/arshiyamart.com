...
<?php
                      ...
                      $wc=DB::table("ac_join_r")->where('user_id', $main_w)->where('status', 1)-> count();
...
<h2 style="color:red; padding:20px 50px; text-align:center"> Product Re-Purchase </span><br>
 </h2>
...
<h4 style="color:black; padding:20px 50px; text-align:center">      <span style="color:green"> আপনার একটি Payment  এর আবেদন সফলভাবে  সম্পন্ন হয়েছে। যা অপেক্ষমান রয়েছে,  এটি সম্পন্ন হওয়ার পর আপনি পুনরায় Re-Purchace করতে পারবেন। </span><br>
 </h4>
@else
...
বিকাশ/রকেট/নগদে পে করলে নিচের বক্স TrxID লিখুন। যদি ক্যাশ পেমেন্ট হয়, তাহলে প্রাপ্ত মানি রিসিপ্ট নম্বর লিখতে হবে ও  ব্যাংক পেমেন্ট হয় তাহলে টাকা প্রদানের স্লিপ নম্বর লিখতে হবে। 
			...
			<form id="account_Form" class="aa-login-form" name="accountForm" action="{{ url('/my_r') }}" method="post">
...
<label> Amount:  (যত টাকার প্রডাক্ট ক্রয় করিতে ইচ্ছুক)</label><br>


    	<input name="package" type="number"  placeholder="Amount" min="500" required="" >
