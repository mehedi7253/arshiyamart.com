...
-->              <input type="hidden" name="price" id="price" value="{{ $pro_details->price }}">
 ...
 @if($size_co == 0)
  ...
  @endif
   ...
   @if(!empty($pro_details->extra6)) 
   <br>
   <div style="border:1px dashed red">
   <sapn><i class="fa fa-check" aria-hidden="true" style="color:green"></i>
 <b>Installment Facility:</b> <span style="color:green">Yes</sapn></sapn><br>
 
 
   <sapn><i class="fa fa-check" aria-hidden="true" style="color:green"></i>
 <b>Down Payment:</b> <span style="color:red"> {{$pro_details->extra6}}</sapn></sapn><br>
 </div>
  @endif               
                  
                  
                  
                  @if($pro_details->extra11  > 0)
                        <span class="aa-product-view-price"style="font-size:100%; background:green;color:white; padding:4px; border-radius:4px" id="affiliate">  Comission {{ $pro_details->extra11  }}  </span><br>
                  @endif       
  ...
  document.execCommand("copy");
     ...
     $("#hhhe").show();
           ...
           @if(!empty($pro_details->extra5))
                      <h4 style="text-align:center">Product Video</h4>
                  <div class="com_add"   style="text-align:center" >

                      <iframe width="560" height="315" src="https://www.youtube.com/embed/{{$pro_details->extra5}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                      </div>     
                                      <div class="mob_add"   style="text-align:center" >

                      <iframe width="330" height="260" src="https://www.youtube.com/embed/{{$pro_details->extra5}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                      </div> 
              @endif        
              ...
              <div class="tab-content">
               ...
               @if(!empty($pro_details->brand))  
                ...
                @if($pro_details->brand !="N/A")
                 <p style="color:blue"><i class="fa fa-check" aria-hidden="true"></i>
 Brand: {{ $pro_details->brand }}</p>
                 @endif       
              ...
              @endif    
                ...
                <?php
                    ...
                    ;?>
                         ...
                         <?php 
                         $own_dist=$aa_dist_sesstione->dist_name;
                         ?>
                         @endif
                         
                         

                @if($pro_details->extra3 > 0)
                 <p style="color:blue"><i class="fa fa-check" aria-hidden="true"></i>
 অতিরিক্ত ডেলিভারী চার্জ (  {{ @$own_dist}} জেলা): {{ $pro_details->extra3 }}</p>
                 @endif       

                 

                     @if($pro_details->extra4 > 0)
                 <p style="color:blue"><i class="fa fa-check" aria-hidden="true"></i>
 অতিরিক্ত ডেলিভারী চার্জ  (অন্য জেলা): {{ $pro_details->extra4 }}</p>
                 @endif                  
