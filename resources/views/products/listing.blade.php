...
<section id="aa-product-category">
    <div class="container">
      <div class="row">
				...
				<div class="mob_add" style="margin-top:-4px">
				    												<div style="width:100%; height:100px; text-align:center; float:left"><img src="{{url('/')}}/assets/admin/img/category_icon/{{$banarimg}}" style="width:100%; max-height:100px"></div>

				</div>
				
				<div class="com_add" style="margin-top:37px">
				    												<div style="width:100%; height:200px; text-align:center; float:left"><img src="{{url('/')}}/assets/admin/img/category_icon/{{$banarimg}}" style="width:100%; max-height:200px"></div>
                ...
                @endif 
						                      ...
						                      <div style="margin-left:5%; margin-top:0px; padding-top:4px;font-size:100%"> <span style="color:green"> <i class="fa fa-arrow-left" aria-hidden="true" style="color:red"></i><a href="{{('/')}}"> Back to Top Category</a></span> </div>
