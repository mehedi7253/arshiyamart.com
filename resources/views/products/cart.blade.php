...
if( $cuppp_dis2 > 0){
    ...
    Session::put('coupon_dis',"");
         ...
         ;?>
                    ...
                    <?php
                              					@$check_installment+=DB::table('products')->where('id',$cart->product_id)->sum('extra8');
                              					@$affiliate_com+=DB::table('products')->where('id',$cart->product_id)->sum('extra11');
                    ?>
 ...
 ?>
        ...
        else
        {
         ...
         ;?>       
            ...
            @if($user_show > 0)
             <div style="width:100%; text-align:right; text-align:right; font-size:120%; color:red;">
                                   আপনার এ্যাফেলিয়েট কমিশনঃ  {{$affiliate_com}}
                                   
                                   <?php
                                     Session::put('my_aff_com', $affiliate_com);
                                   ;?>
             </div>
            @endif   
 @endif                 
