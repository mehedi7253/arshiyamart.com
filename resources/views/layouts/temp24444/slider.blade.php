<!-- Start slider -->
  <section id="aa-slider">
    <div class="com_add" class="aa-slider-area" style="height:300px; margin-bottom:10px">
...
@endforeach
 ...
 <div  style="width:100%; height:300px;">
  ...
  <!--
     ...
     <div class="mob_add" style="width:30%; height:100px; float:left;">
         <div style="width:100%; height:137px; border:4px solid silver">
               <a href="{{ $url1 }}">
              <img  src="{{url('/')}}/assets/admin/img/banners/<?php echo $image1;?>" alt="sl1 slide img" style="width:100%; height:100%;"/>
              </a>
         </div>
         
          <div style="width:100%; height:110px; border:4px solid silver">
                <a href="{{ $url4 }}">
              <img  src="{{url('/')}}/assets/admin/img/banners/<?php echo $image4;?>" alt="sl1 slide img"  style="width:100%; height:100%;">
              </a>
         </div>
         <div style="width:100%; height:137px; border:4px solid silver">
               <a href="{{ $url5 }}">
     ...
     <div class="com_add"  style="width:30%; height:100px; float:left;">
          <div style="width:100%; height:150px; border:4px solid silver">
                <a href="{{ $url4 }}">
              <img  src="{{url('/')}}/assets/admin/img/banners/<?php echo $image4;?>" alt="sl1 slide img"  style="width:100%; height:100%;">
              </a>
         </div>
