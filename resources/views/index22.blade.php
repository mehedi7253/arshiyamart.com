    ...
    <div class="container" style="background:white; border-radius:6px">
      <div class="row">
          ...
          <div class="row" style="margin-top:10px">
                <span style="color:black; padding:8px; font-size:120%; "><i class="fa fa-bullhorn" aria-hidden="true" style="font-size:140%; color:black"></i><b> Campaign Product  </b></span>  
               
                 <hr> 
            <div class="aa-product-area" style="margin-top:15px">
     ...
     @else
      ...
      ?>
                             ...
                             <div class="" style="background:{{$bg_t_c}};  padding:2px">
                               <a href="{{ url('/product/'.$product->id) }}" style="color:white"> <span class="fa fa-shopping-cart"> </span>  
                               Buy Now
                              </a>
                              </div>
                              @else     
                         ...
                         <!--     <div class="" style="background:{{$bg_t_c}};  padding:2px 0px; width:50%; margin-left:-1px; margin-right:1px; float:left">
                             <a href="{{ url('/product/'.$product->id) }}" style="color:white; font-size:80%"><span class="fa fa-shopping-cart"></span> 
                              Details
                               </a>
                               </div>-->
...
<section id="aa-product-category" style="margin-top:5px">
    <div class="container" style="background:white; border-radius:6px">
      <div class="row">
          <div class="col-lg-12 col-md-9 col-sm-8 col-md-push-0">
   ...
   <span style="color:black; padding:8px; font-size:120%; "><b> {{@$ct1->name}}  </b></span>  
