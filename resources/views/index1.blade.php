...
<div class="w3-content w3-section" style="height:160px; width:100%; float:left">
 <a href="<?php echo $url1;?>">  <img class="mySlides" src="{{url('/')}}/assets/admin/img/banners/<?php echo $image1;?>" style="height:160px;width:100%"></a>
 <a href="<?php echo $url2;?>">  <img class="mySlides" src="{{url('/')}}/assets/admin/img/banners/<?php echo $image2;?>" style="height:160px;width:100%"></a>
 <a href="<?php echo $url3;?>">  <img class="mySlides" src="{{url('/')}}/assets/admin/img/banners/<?php echo $image3;?>" style="height:160px;width:100%"></a>
  
  
  
  
  <a href="<?php echo $url55;?>"><img class="mySlides" src="{{url('/')}}/assets/admin/img/banners/<?php echo $image55;?>" style="height:180px;width:100%"></a>

  
     <a href="<?php echo $url56;?>"><img class="mySlides" src="{{url('/')}}/assets/admin/img/banners/<?php echo $image56;?>" style="height:180px;width:100%"></a>

   <a href="<?php echo $url57;?>"> <img class="mySlides" src="{{url('/')}}/assets/admin/img/banners/<?php echo $image57;?>" style="height:180px;width:100%"></a>

   <a href="<?php echo $url58;?>"> <img class="mySlides" src="{{url('/')}}/assets/admin/img/banners/<?php echo $image58;?>" style="height:180px;width:100%"></a>
...
<div class="mob_add" style="width:100%; margin:auto; color:white">
...
<div class="com_add" style="width:85%; margin:auto; color:white">
    <span style="background:{{ $bg_t_c }}; padding:10px 0px 0px 0px; line-hight:auto; font-size:110%; margin-bottom:10px; margin-top:-10px">
                    <marquee>
<?php echo $image39;?>
</marquee>
 ...
 <ul class="nav nav-tabs aa-products-tab">
                    <li class="active" ><a href="#men" data-toggle="tab" style="background:{{$bg_t_c}}; color:white;   border-top-right-radius: 8px; border-top-left-radius: 8px;"  ><span >Megha Shop</span>
		...
		<div class="col-3 col-md-2 col-sm-4 col-xs-4"  style="margin-top:5px; float:left;  padding:6px;" >
				   	<a href="{{url('/')}}/shop/{{$bnp->id}}"> 
    				   	<div style="float:left; width:100%; padding: 1px 1px; background:#FFFFFF; font-size:120%; color:black; border-radius:4px;text-align:center; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
    				        @if(!empty($bnp->logo))
    				        <img src="{{url('/')}}/assets/admin/img/shops/{{$bnp->logo}}" style="max-width:100%;border-radius:4px;">
...
"> {{$bnp->shop_name}}</div> 
 ...
 <ul class="nav nav-tabs aa-products-tab">
                    <li class="active" ><a href="#men" data-toggle="tab" style="background:{{$bg_t_c}}; color:white;   border-top-right-radius: 8px; border-top-left-radius: 8px;"  ><span >Shop by Brand</span>
	...
	@foreach ($bangladesh_n_p as $bnp)		
			...
			<div class="col-3 col-md-1 col-sm-3 col-xs-3"  style="margin-top:5px; float:left;  padding:6px;" >
				   	<a href="{{url('/')}}/search2/{{$bnp->name}}"> 
    				   	<div  style=" float:left; padding: 1px 1px; background:#FFFFFF; font-size:120%; color:black; border-radius:4px;text-align:center; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
    				        @if(!empty($bnp->img))
    				        <img src="{{url('/')}}/assets/admin/img/category_icon/{{$bnp->img}}" style="width:80px">
    				        @else
<i class="fa fa-paper-plane" aria-hidden="true" style="font-size:100%"></i>
...
<section id="aa-product-category">
    <div class="container">
     ...
     <?php
      ...
      $allproducts=DB::table('products')->where('parent_id',@$ct1->id)->orderby('id','DESC')->limit(15)->get();
      ;?>    
      ...
      ?>
                         ...
                         <!--     <div class="" style="background:{{$bg_t_c}};  padding:2px 0px; width:50%; margin-left:-1px; margin-right:1px; float:left">
                             <a href="{{ url('/product/'.$product->id) }}" style="color:white; font-size:80%"><span class="fa fa-eye"></span> 
                              ...
                              <div class=""  id="newlo{{$product->id}}" style="background:{{$bg_t_c}}; text-align:center; margin:auto;  padding:2px 0px; width:80%; border-radius:5px; ">
